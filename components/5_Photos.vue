<template>
  <section id="photos" class="hero is-fullheight-with-navbar">
    <div class="hero-head">
      ...
      <h2 class="subtitle is-size-5-mobile is-size-6-tablet">Récapitulatif de nos 7 ans de couple.</h2>
    </div>
    <div class="hero-body">
      <div class="container">
...
export default {
  data() {
    return {
      cards: [
        {
          image: require("@/components/images/scrollsnap_photos/2013.jpg"),
          alternative_description: "CDMGE",
          date: "6 Juin 2013",
          description: "Premiere CDMGE pour encourager Roxane aux pompom girls."
        },
        {
          image: require("@/components/images/scrollsnap_photos/2014.png"),
        ...
        {
          image: require("@/components/images/scrollsnap_photos/2019.jpg"),
        ...
        {
          image: require("@/components/images/scrollsnap_photos/2020.jpg"),
